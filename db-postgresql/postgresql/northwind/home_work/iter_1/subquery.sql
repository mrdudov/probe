...
-- 2. Напишите запрос,
--     который выводит общую сумму фрахтов заказов для компаний-заказчиков для заказов,
...
-- 3. Напишите запрос,
--     который выводит 3 заказа с наибольшей стоимостью, 
...
WHERE 
    order_date >= '1997-09-01'
    AND ship_country IN (
        'Argentina', 'Bolivia', 'Brazil', 'Chili', 'Colombia',
        'Ecuador', 'Guyana', 'Paraguay', 'Peru', 'Surinama', 
        'Uruguay', 'Venezuela')
